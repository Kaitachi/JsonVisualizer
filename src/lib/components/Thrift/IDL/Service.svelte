<script>
	import { service } from "$lib/Thrift/IDL/stores";
...
<div class="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-0">
	<div class="sm:col-span-3 [&>:first-child]:mt-0 [&>:last-child]:mb-0">
		{#each methods as method}
			<Method method={method} />
		{/each}
	</div>
	<div class="sticky top-20 [&>:first-child]:mt-0 [&>:last-child]:mb-0">
		<div>
			ENUMS
		</div>
		<div>
